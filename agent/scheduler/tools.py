...
def schedule_task(task_description: str, delay_minutes: int = 0, repeat_every_minutes: int = 0) -> str:
    ...
    """
    from agent.scheduler.engine import add_one_shot_task, add_interval_task
...
def schedule_cron_task(task_description: str, cron_expression: str) -> str:
    ...
    """
    from agent.scheduler.engine import add_cron_task
...
def list_scheduled_tasks() -> str:
    ...
    """
    from agent.scheduler.engine import get_all_tasks
...
def cancel_scheduled_task(task_id: str) -> str:
    ...
    """
    from agent.scheduler.engine import remove_task
...
def watch_folder(folder_path: str) -> str:
    ...
    """
    from agent.scheduler.watcher import start_watching
...
def stop_watching_folder(folder_path: str) -> str:
    ...
    """
    from agent.scheduler.watcher import stop_watching
